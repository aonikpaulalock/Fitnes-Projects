      ...
      <div className="row">
        <div className="col-lg-7">
          <div className="details-text-content">
            ...
            <img src={DetailsImg} alt="" className="details-image" />
              ...
              <>
                ...
                <div className="class-details-summary">
                  ...
                  <div className="details-duration-container">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#BCB8D0" class="bi bi-alarm-fill me-3" viewBox="0 0 18 18">
                  ...
                  <div className="details-duration-container">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#BCB8D0" class="bi bi-dash-circle-fill me-3" viewBox="0 0 18 18">
                  ...
                  <div className="details-duration-container">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#BCB8D0" class="bi bi-tools me-3" viewBox="0 0 18 18">
                  ...
                  <div className="details-duration-container">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#BCB8D0" class="bi bi-calendar-fill me-3" viewBox="0 0 18 18">
